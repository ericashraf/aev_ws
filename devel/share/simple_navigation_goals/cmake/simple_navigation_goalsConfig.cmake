...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/eric/aev_ws/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/eric/aev_ws/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/eric/aev_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eric/aev_ws/src/simple_navigation_goals/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(simple_navigation_goals_EXPORTED_TARGETS ${${simple_navigation_goals_dep}_EXPORTED_TARGETS})
endforeach()
